/*
1. Константные (сумма чисел от 1 до n) -0(1)
2. Линейные (сумма чисел от 1 до n) - O(n)
3. Квадратичные (сортировка пузырьком, выбором, вставками) - О(n^2)
4. Логарифмические (Бинарный поиск) - О(log2(n))
5. Линейно-логарифмические (Быстрая сортировка) - О(n * log2(n))
